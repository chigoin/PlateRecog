...
namespace PlateRecog
{
    class MainAccess
    {
        static void Main(string[] args)
        {
            ...
            //Console.ReadKey();
            //训练字符识别库
            //DataPreparingForSVM.TrainSVMDataForCharRecog(@"C:\Users\faiz\Desktop\AI\车牌-字符样本\车牌-字符样本\chars\");
            //Console.ReadKey();
            ...
            //Console.ReadKey();
            //对最终的测试进行测试
            //List<string> finalResult = PlateRevogTool.GetRecogFinalResult(@"C:\Users\faiz\Desktop\AI\img_source\100B23_2019-03-20-11-48-44-004609.jpg");
